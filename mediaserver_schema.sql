...
CREATE TABLE Playlist_Songs(
    ...
    playlist_track_num INTEGER NOT NULL,
...
create or replace function mediaserver.addplaylist(
    playlist_name varchar(100),
    playlist_id int)
RETURNS bigint AS
$BODY$
    -- INSERT INTO mediaserver.playlist VALUES (playlist_name, playlist_id);
    SELECT count(*) FROM mediaserver.playlist;
$BODY$
LANGUAGE sql;
